...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
	...
	if (cellIsRight) { // User's post so create blue bubble
		...
		if (cell == nil) {
			...
			UIImageView *backgroundImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"blueBubble.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(30.0f, 11.0f, 16.0f, 11.0f)]];
